...
try:
	opts, args = getopt.getopt(sys.argv[1:],"ha:i:s:f:m:o:")
except getopt.GetoptError:
	print("Option not recognised.")
	print("python evaluate_write_file.py -a <MSA file> -i <invariants file> -m <model>")
	print("python evaluate_write_file.py -h for further usage instructions.")
	sys.exit(2)
for opt, arg in opts:
	if opt == "-h":
		print("python evaluate_write_file.py -a <MSA file> -i <invariants file> -s <scoring method>")
